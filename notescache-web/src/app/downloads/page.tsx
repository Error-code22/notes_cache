      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <div className="mt-6 text-sm text-gray-500">
            On iPhone or Mac? The website works as an app —{' '}
            <a href="/" className="text-indigo-600 font-medium hover:underline">open NotesCache</a> and add it to your Home Screen.
          </div>
